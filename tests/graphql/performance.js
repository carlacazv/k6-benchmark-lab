...
export const options = { summaryTrendStats: ['avg', 'min', 'med', 'max', 'p(90)', 'p(95)', 'p(99)'], scenarios: selectedScenario(env.scenario), thresholds: protocolThresholds(), discardResponseBodies: false, tags: { protocol: 'graphql', scenario: env.scenario } };
